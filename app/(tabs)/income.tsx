...
export default function ExpensesScreen() {
  ...
  const homeIncome = parseFloat(params.currentIncome as string) || 10700.0;
  const homeExpense = parseFloat(params.currentExpense as string) || 5950.0;
  ...
  const handleSaveIncome = () => {
    if (!detail.trim() && !amount.trim()) {
      Alert.alert("ข้อความเตือน", "กรุณากรอกรายการเงินเข้าและจำนวนเงิน");
      return;
    }
    if (!detail.trim()) {
      Alert.alert("ข้อความเตือน", "กรุณากรอกรายการเงินเข้า");
      return;
    }
    if (!amount.trim()) {
      Alert.alert("ข้อความเตือน", "กรุณากรอกจำนวนเงินเข้า");
      return;
    }
    ...
    Alert.alert("ผลการทำงาน", "บันทึกรายรับเข้าฐานข้อมูลเรียบร้อยแล้ว", [
      {
        text: "ตกลง",
        onPress: () => {
      ...
      >
        <View style={styles.headerSection}>
          <View style={styles.userInfoRow}>
            <Text style={styles.userName}>Rujirada Hongsingthong</Text>
            <Image
        ...
        <View style={styles.formSection}>
          ...
          <Text style={styles.directionSub}>เงินเข้า</Text>

          <View style={styles.inputWrapper}>
            <View style={styles.floatingLabelContainer}>
              <Text style={styles.floatingLabelText}>รายการเงินเข้า</Text>
            </View>
            <TextInput
          ...
          <View style={styles.inputWrapper}>
            <View style={styles.floatingLabelContainer}>
              <Text style={styles.floatingLabelText}>จำนวนเงินเข้า</Text>
            </View>
            <TextInput
              style={styles.textInput}
              placeholder="0.00"
          ...
          <TouchableOpacity
            style={styles.submitBtnIncome}
            onPress={handleSaveIncome}
          >
            <Text style={styles.submitBtnText}>บันทึกเงินเข้า</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
